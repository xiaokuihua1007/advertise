...
@Service
public class ProjectListGetSampler extends AbstarctSampler<ProjectListGet.Param> {

    public static final String collection = "Dy_ProjectListGet";

    @Override
    public List<GroupFail<ProjectListGet.Param>> doSample(List<Param<ProjectListGet.Param>> params) {
        ...
        return new PageGroup<>(SamplerUtil.page(ProjectListGet.class), params, consumer).execute();
    }
}
